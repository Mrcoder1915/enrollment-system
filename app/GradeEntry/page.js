  ...
  return (
    <div>
      <div className="mt-10 px-75 pt-4 pb-2 flex items-center gap-2">
        <label htmlFor="term" className="font-medium mr-2 text-xl">
          Term:
        </label>
        <select id="term" className="border border-black-300 p-0.5 rounded-md w-47">
      ...
      <div className="w-[90%] max-w-3xl mx-auto bg-white shadow-[4px_4px_10px_rgba(0,0,0,0.40)] rounded-lg overflow-hidden">
        <div className="overflow-y-auto hide-scrollbar max-h-[510px]">
          <table className="w-full table-auto border-collapse">
            <thead>
              ...
              <tr className="bg-gray-300 sticky top-[52px] z-10 text-center border-b">
                <th className="px-5 py-3 text-center border-r">Program</th>
                <th className="px-5 py-3 text-center border-r">Year Level</th>
                <th className="px-5 py-3 text-center border-r">Section</th>
                <th className="px-5 py-3 text-center border-r">Course/Subject</th>
                <th className="px-5 py-3 text-center border-r">Enrolled</th>
                <th className="px-5 py-3 text-center">Select</th>
              </tr>
            </thead>
            <tbody>
            {courseList.map((courseData, index) => (
                  <tr key={index} className="border-b">
                    ...
                    <td className="px-5 py-3 text-center">
                      <button className="bg-yellow-500 text-red-900 py-1 px-4 rounded-md">
                        Select
                      </button>
                    </td>
                  </tr>
