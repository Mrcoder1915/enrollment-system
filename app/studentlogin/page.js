      ...
      <div className="text-center">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-6 w-[350px] mx-auto">
          ...
          <div className="flex justify-end gap-2">
            <button className="bg-yellow-400 hover:bg-yellow-500 text-red-700 font-bold py-2 px-4 rounded">
              Apply Here
            </button>
            <button className="bg-red-700 hover:bg-red-800 text-yellow-300 font-bold py-2 px-4 rounded">
              Log In
            </button>
          </div>
        </div>
